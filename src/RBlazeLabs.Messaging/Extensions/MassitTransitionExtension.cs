using MassTransit;
using RBlazeLabs.Messaging.Contracts;
...
namespace RBlazeLabs.Messaging.Extensions
{
    ...
    public static class MassitTransitionExtension
    {
        ...
        /// <param name="queueName">Queue name</param>
        public static async Task SendCommand<TCommand>
        (
            this IBusControl bus, 
            TCommand messageCommand, 
        ...
        /// <param name="queueName">Queue name</param>
        public static void AddCommandConsumerEndpoint<TCommand, TConsumer>
        (
        ...
        /// <param name="config">RabbitMQ Bus factory configurator</param>
        /// <param name="queueName">Queue name</param>
        public static void AddEventConsumerEndpoint<TEvent, TConsumer>
        (
            this IRabbitMqBusFactoryConfigurator config, 
            string? queueName = null
        )
