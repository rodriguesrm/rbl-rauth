...
using RBlazeLabs.Messaging.Options;

namespace RBlazeLabs.Messaging.Abstractions
{
    ...
    public static class DependencyInjection
    {
        ...
        /// <returns></returns>
        public static IServiceCollection AddMassTransitUsingRabbitMq
        (
        ...
        )
        {
            ...
            //TODO: review documentation for see automatic-registration
        ...
        (
            ...
            string password, 
            Action<IRabbitMqBusFactoryConfigurator>? configure = null
        ) => services.AddMassTransitUsingRabbitMq(serverAddress, null, username, password, configure);
        ...
        (
            this IServiceCollection services, 
            MessagingOption options, 
            Action<IRabbitMqBusFactoryConfigurator>? configure = null
        ) => AddMassTransitUsingRabbitMq
            (services, options.ServerAddress, options.VirtualHost, options.Username, options.Password, configure);
        ...
        (
            ...
            Action<IRabbitMqBusFactoryConfigurator>? configure = null
        ) => services.AddMassTransitUsingRabbitMq(configuration, null, configure);
        ...
        )
        {
            ...
            MessagingOption options = new();
            configuration.GetSection(configSection).Bind(options);
            return AddMassTransitUsingRabbitMq(
                services, 
