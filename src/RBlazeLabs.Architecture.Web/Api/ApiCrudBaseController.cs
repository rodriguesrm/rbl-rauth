...
using RBlazeLabs.Architecture.Web.Resources;
...
namespace RBlazeLabs.Architecture.Web.Api
{
    ...
    /// </summary>
    [ApiController]
    public abstract class ApiCrudBaseController<TDto, TRequest, TResponse> : ApiBaseController
        where TDto : AppDtoIdBase
    {
        ...
        /// <param name="cancellationToken">A System.Threading.CancellationToken to observe while waiting for the task to complete</param>
        protected abstract Task<TDto> GetByIdAsync(int key, CancellationToken cancellationToken = default);
        ...
        /// <param name="key">Entity key value</param>
        /// <param name="cancellationToken">A System.Threading.CancellationToken to observe while waiting for the task to complete</param>
        protected abstract Task RemoveAsync(int key, CancellationToken cancellationToken = default);
        ...
        protected async Task<IActionResult> RunInsertAsync(TRequest request, CancellationToken cancellationToken = default)
        {
            ...
            if (!dto.IsValid)
            {
                IEnumerable<Notification> msg = GetNotificationsErrors(dto.Notifications);
        ...
        /// <param name="cancellationToken">A System.Threading.CancellationToken to observe while 
        /// waiting for the task to complete</param>
        protected async Task<IActionResult> RunUpdateAsync(int key, TRequest request, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">A System.Threading.CancellationToken to observe while 
        /// waiting for the task to complete</param>
        protected virtual async Task<IActionResult> GetAsync(int key, CancellationToken cancellationToken = default)
        ...
        /// <param name="cancellationToken">A System.Threading.CancellationToken to observe while 
        /// waiting for the task to complete</param>
        protected virtual async Task<IActionResult> UpdateAsync(int key, TRequest request, CancellationToken cancellationToken = default)
        ...
        /// <param name="cancellationToken">A System.Threading.CancellationToken to observe while 
        /// waiting for the task to complete</param>
        protected virtual async Task<IActionResult> DeleteAsync(int key, CancellationToken cancellationToken = default)
